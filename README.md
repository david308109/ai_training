...
| **Intent Guard** | **KNN Score Threshold in Retrieval Step** | **Zero LLM calls for chitchat/non-DB queries. If highest retrieval score < 0.75, pipeline directly returns guided response.** |
